# Bappaditya Sinha — Java Backend Developer Portfolio
...
Hi, I'm **Bappaditya** — a Java Backend Developer with **2.2 years of industrial experience** and **4 years of research & development experience in Network Systems**.

I'm strongest in **Java, Spring Boot, REST APIs, Microservices, PostgreSQL, and AWS**, with hands-on experience in Docker, Kubernetes, Kafka, Redis, CI/CD, and system design. I enjoy building reliable backend systems, solving performance problems, and turning complex requirements into scalable software.

Currently building production-style applications while exploring **Gen AI and Spring AI**.
...
```bash
git clone https://github.com/bappaditya92/portfolio.git
```
